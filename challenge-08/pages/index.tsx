...
import Piyechart from "../components/piyechart";
      ...
      <div className="container mx-auto px-32">
          ...
          <div className="w-2/5">
            ...
            <ul className="flex flex-col space-y-4">
              <li className="flex items-center">
                <Image
                  src="/images/icon/checklist-our-service.png"
                  alt="checklist icon"
                  layout="fixed"
                  width={24}
                  height={24}
        ...
        <section className="container mx-auto h-96">
          ...
          <div className="flex space-x-6 pt-10">
            ...
            <div className="w-1/4 rounded-lg border border-gray-400 p-4">
              <Image
                src="/images/icon/icon-price.png"
                alt="price icon"
                layout="fixed"
                width={32}
                height={32}
            ...
            <div className="w-1/4 rounded-lg border border-gray-400 p-4">
              <Image
                src="/images/icon/icon-24hrs.png"
                alt="24hrs icon"
                layout="fixed"
                width={32}
                height={32}
            ...
            <div className="w-1/4 rounded-lg border border-gray-400 p-4">
              <Image
                src="/images/icon/icon-professional.png"
